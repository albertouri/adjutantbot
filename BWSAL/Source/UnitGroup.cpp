...
namespace BWSAL
{
  bool passesFlag( BWAPI::Unit* u, int f )
  {
    ...
    switch( f )
    {
      ...
      break;
      case Firebat:
        if( u->getType() == BWAPI::UnitTypes::Terran_Firebat ) return true;
      break;
      case Ghost:
        if( u->getType() == BWAPI::UnitTypes::Terran_Ghost ) return true;
      break;
      case Goliath:
        if( u->getType() == BWAPI::UnitTypes::Terran_Goliath ) return true;
      break;
      case Marine:
        if( u->getType() == BWAPI::UnitTypes::Terran_Marine ) return true;
      break;
      case Medic:
        if( u->getType() == BWAPI::UnitTypes::Terran_Medic ) return true;
      break;
      case SCV:
        if( u->getType() == BWAPI::UnitTypes::Terran_SCV ) return true;
      break;
      case Siege_Tank:
        if( u->getType() == BWAPI::UnitTypes::Terran_Siege_Tank_Tank_Mode ) return true;
        if( u->getType() == BWAPI::UnitTypes::Terran_Siege_Tank_Siege_Mode ) return true;
      break;
      case Vulture:
        if( u->getType() == BWAPI::UnitTypes::Terran_Vulture ) return true;
      break;
      case Vulture_Spider_Mine:
        if( u->getType() == BWAPI::UnitTypes::Terran_Vulture_Spider_Mine ) return true;
      break;
      case Battlecruiser:
        if( u->getType() == BWAPI::UnitTypes::Terran_Battlecruiser ) return true;
      break;
      case Dropship:
        if( u->getType() == BWAPI::UnitTypes::Terran_Dropship ) return true;
      break;
      case Nuclear_Missile:
        if( u->getType() == BWAPI::UnitTypes::Terran_Nuclear_Missile ) return true;
      break;
      case Science_Vessel:
        if( u->getType() == BWAPI::UnitTypes::Terran_Science_Vessel ) return true;
      break;
      case Valkyrie:
        if( u->getType() == BWAPI::UnitTypes::Terran_Valkyrie ) return true;
      break;
      case Wraith:
        if( u->getType() == BWAPI::UnitTypes::Terran_Wraith ) return true;
      break;
      case Alan_Schezar:
        if( u->getType() == BWAPI::UnitTypes::Hero_Alan_Schezar ) return true;
      break;
      case Alexei_Stukov:
        if( u->getType() == BWAPI::UnitTypes::Hero_Alexei_Stukov ) return true;
      break;
      case Arcturus_Mengsk:
        if( u->getType() == BWAPI::UnitTypes::Hero_Arcturus_Mengsk ) return true;
      break;
      case Edmund_Duke:
        if( u->getType() == BWAPI::UnitTypes::Hero_Edmund_Duke_Siege_Mode ) return true;
        if( u->getType() == BWAPI::UnitTypes::Hero_Edmund_Duke_Tank_Mode ) return true;
      break;
      case Gerard_DuGalle:
        if( u->getType() == BWAPI::UnitTypes::Hero_Gerard_DuGalle ) return true;
      break;
      case Gui_Montag:
        if( u->getType() == BWAPI::UnitTypes::Hero_Gui_Montag ) return true;
      break;
      case Hyperion:
        if( u->getType() == BWAPI::UnitTypes::Hero_Hyperion ) return true;
      break;
      case Jim_Raynor_Marine:
        if( u->getType() == BWAPI::UnitTypes::Hero_Jim_Raynor_Marine ) return true;
      break;
      case Jim_Raynor_Vulture:
        if( u->getType() == BWAPI::UnitTypes::Hero_Jim_Raynor_Vulture ) return true;
      break;
      case Magellan:
        if( u->getType() == BWAPI::UnitTypes::Hero_Magellan ) return true;
      break;
      case Norad_II:
        if( u->getType() == BWAPI::UnitTypes::Hero_Norad_II ) return true;
      break;
      case Samir_Duran:
        if( u->getType() == BWAPI::UnitTypes::Hero_Samir_Duran ) return true;
      break;
      case Sarah_Kerrigan:
        if( u->getType() == BWAPI::UnitTypes::Hero_Sarah_Kerrigan ) return true;
      break;
      case Tom_Kazansky:
        if( u->getType() == BWAPI::UnitTypes::Hero_Tom_Kazansky ) return true;
      break;
      case Civilian:
        if( u->getType() == BWAPI::UnitTypes::Terran_Civilian ) return true;
      break;
      case Academy:
        if( u->getType() == BWAPI::UnitTypes::Terran_Academy ) return true;
      break;
      case Armory:
        if( u->getType() == BWAPI::UnitTypes::Terran_Armory ) return true;
      break;
      case Barracks:
        if( u->getType() == BWAPI::UnitTypes::Terran_Barracks ) return true;
      break;
      case Bunker:
        if( u->getType() == BWAPI::UnitTypes::Terran_Bunker ) return true;
      break;
      case Command_Center:
        if( u->getType() == BWAPI::UnitTypes::Terran_Command_Center ) return true;
      break;
      case Engineering_Bay:
        if( u->getType() == BWAPI::UnitTypes::Terran_Engineering_Bay ) return true;
      break;
      case Factory:
        if( u->getType() == BWAPI::UnitTypes::Terran_Factory ) return true;
      break;
      case Missile_Turret:
        if( u->getType() == BWAPI::UnitTypes::Terran_Missile_Turret ) return true;
      break;
      case Refinery:
        if( u->getType() == BWAPI::UnitTypes::Terran_Refinery ) return true;
      break;
      case Science_Facility:
        if( u->getType() == BWAPI::UnitTypes::Terran_Science_Facility ) return true;
      break;
      case Starport:
        if( u->getType() == BWAPI::UnitTypes::Terran_Starport ) return true;
      break;
      case Supply_Depot:
        if( u->getType() == BWAPI::UnitTypes::Terran_Supply_Depot ) return true;
      break;
      case Comsat_Station:
        if( u->getType() == BWAPI::UnitTypes::Terran_Comsat_Station ) return true;
      break;
      case Control_Tower:
        if( u->getType() == BWAPI::UnitTypes::Terran_Control_Tower ) return true;
      break;
      case Covert_Ops:
        if( u->getType() == BWAPI::UnitTypes::Terran_Covert_Ops ) return true;
      break;
      case Machine_Shop:
        if( u->getType() == BWAPI::UnitTypes::Terran_Machine_Shop ) return true;
      break;
      case Nuclear_Silo:
        if( u->getType() == BWAPI::UnitTypes::Terran_Nuclear_Silo ) return true;
      break;
      case Physics_Lab:
        if( u->getType() == BWAPI::UnitTypes::Terran_Physics_Lab ) return true;
      break;
      case Crashed_Norad_II:
        if( u->getType() == BWAPI::UnitTypes::Special_Crashed_Norad_II ) return true;
      break;
      case Ion_Cannon:
        if( u->getType() == BWAPI::UnitTypes::Special_Ion_Cannon ) return true;
      break;
      case Power_Generator:
        if( u->getType() == BWAPI::UnitTypes::Special_Power_Generator ) return true;
      break;
      case Psi_Disrupter:
        if( u->getType() == BWAPI::UnitTypes::Special_Psi_Disrupter ) return true;
      break;
      case Archon:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Archon ) return true;
      break;
      case Dark_Archon:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Dark_Archon ) return true;
      break;
      case Dark_Templar:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Dark_Templar ) return true;
      break;
      case Dragoon:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Dragoon ) return true;
      break;
      case High_Templar:
        if( u->getType() == BWAPI::UnitTypes::Protoss_High_Templar ) return true;
      break;
      case Probe:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Probe ) return true;
      break;
      case Reaver:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Reaver ) return true;
      break;
      case Scarab:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Scarab ) return true;
      break;
      case Zealot:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Zealot ) return true;
      break;
      case Arbiter:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Arbiter ) return true;
      break;
      case Carrier:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Carrier ) return true;
      break;
      case Corsair:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Corsair ) return true;
      break;
      case Interceptor:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Interceptor ) return true;
      break;
      case Observer:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Observer ) return true;
      break;
      case Scout:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Scout ) return true;
      break;
      case Shuttle:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Shuttle ) return true;
      break;
      case Aldaris:
        if( u->getType() == BWAPI::UnitTypes::Hero_Aldaris ) return true;
      break;
      case Artanis:
        if( u->getType() == BWAPI::UnitTypes::Hero_Artanis ) return true;
      break;
      case Danimoth:
        if( u->getType() == BWAPI::UnitTypes::Hero_Danimoth ) return true;
      break;
      case Hero_Dark_Templar:
        if( u->getType() == BWAPI::UnitTypes::Hero_Dark_Templar ) return true;
      break;
      case Fenix_Dragoon:
        if( u->getType() == BWAPI::UnitTypes::Hero_Fenix_Dragoon ) return true;
      break;
      case Fenix_Zealot:
        if( u->getType() == BWAPI::UnitTypes::Hero_Fenix_Zealot ) return true;
      break;
      case Gantrithor:
        if( u->getType() == BWAPI::UnitTypes::Hero_Gantrithor ) return true;
      break;
      case Mojo:
        if( u->getType() == BWAPI::UnitTypes::Hero_Mojo ) return true;
      break;
      case Raszagal:
        if( u->getType() == BWAPI::UnitTypes::Hero_Raszagal ) return true;
      break;
      case Tassadar:
        if( u->getType() == BWAPI::UnitTypes::Hero_Tassadar ) return true;
      break;
      case Tassadar_Zeratul_Archon:
        if( u->getType() == BWAPI::UnitTypes::Hero_Tassadar_Zeratul_Archon ) return true;
      break;
      case Warbringer:
        if( u->getType() == BWAPI::UnitTypes::Hero_Warbringer ) return true;
      break;
      case Zeratul:
        if( u->getType() == BWAPI::UnitTypes::Hero_Zeratul ) return true;
      break;
      case Arbiter_Tribunal:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Arbiter_Tribunal ) return true;
      break;
      case Assimilator:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Assimilator ) return true;
      break;
      case Citadel_of_Adun:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Citadel_of_Adun ) return true;
      break;
      case Cybernetics_Core:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Cybernetics_Core ) return true;
      break;
      case Fleet_Beacon:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Fleet_Beacon ) return true;
      break;
      case Forge:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Forge ) return true;
      break;
      case Gateway:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Gateway ) return true;
      break;
      case Nexus:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Nexus ) return true;
      break;
      case Observatory:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Observatory ) return true;
      break;
      case Photon_Cannon:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Photon_Cannon ) return true;
      break;
      case Pylon:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Pylon ) return true;
      break;
      case Robotics_Facility:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Robotics_Facility ) return true;
      break;
      case Robotics_Support_Bay:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Robotics_Support_Bay ) return true;
      break;
      case Shield_Battery:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Shield_Battery ) return true;
      break;
      case Stargate:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Stargate ) return true;
      break;
      case Templar_Archives:
        if( u->getType() == BWAPI::UnitTypes::Protoss_Templar_Archives ) return true;
      break;
      case Khaydarin_Crystal_Form:
        if( u->getType() == BWAPI::UnitTypes::Special_Khaydarin_Crystal_Form ) return true;
      break;
      case Protoss_Temple:
        if( u->getType() == BWAPI::UnitTypes::Special_Protoss_Temple ) return true;
      break;
      case Stasis_Cell_Prison:
        if( u->getType() == BWAPI::UnitTypes::Special_Stasis_Cell_Prison ) return true;
      break;
      case Warp_Gate:
        if( u->getType() == BWAPI::UnitTypes::Special_Warp_Gate ) return true;
      break;
      case XelNaga_Temple:
        if( u->getType() == BWAPI::UnitTypes::Special_XelNaga_Temple ) return true;
      break;
      case Broodling:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Broodling ) return true;
      break;
      case Defiler:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Defiler ) return true;
      break;
      case Drone:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Drone ) return true;
      break;
      case Egg:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Egg ) return true;
      break;
      case Hydralisk:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Hydralisk ) return true;
      break;
      case Infested_Terran:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Infested_Terran ) return true;
      break;
      case Larva:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Larva ) return true;
      break;
      case Lurker:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Lurker ) return true;
      break;
      case Lurker_Egg:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Lurker_Egg ) return true;
      break;
      case Ultralisk:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Ultralisk ) return true;
      break;
      case Zergling:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Zergling ) return true;
      break;
      case Cocoon:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Cocoon ) return true;
      break;
      case Devourer:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Devourer ) return true;
      break;
      case Guardian:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Guardian ) return true;
      break;
      case Mutalisk:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Mutalisk ) return true;
      break;
      case Overlord:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Overlord ) return true;
      break;
      case Queen:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Queen ) return true;
      break;
      case Scourge:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Scourge ) return true;
      break;
      case Devouring_One:
        if( u->getType() == BWAPI::UnitTypes::Hero_Devouring_One ) return true;
      break;
      case Hunter_Killer:
        if( u->getType() == BWAPI::UnitTypes::Hero_Hunter_Killer ) return true;
      break;
      case Infested_Duran:
        if( u->getType() == BWAPI::UnitTypes::Hero_Infested_Duran ) return true;
      break;
      case Infested_Kerrigan:
        if( u->getType() == BWAPI::UnitTypes::Hero_Infested_Kerrigan ) return true;
      break;
      case Kukulza_Guardian:
        if( u->getType() == BWAPI::UnitTypes::Hero_Kukulza_Guardian ) return true;
      break;
      case Kukulza_Mutalisk:
        if( u->getType() == BWAPI::UnitTypes::Hero_Kukulza_Mutalisk ) return true;
      break;
      case Matriarch:
        if( u->getType() == BWAPI::UnitTypes::Hero_Matriarch ) return true;
      break;
      case Torrasque:
        if( u->getType() == BWAPI::UnitTypes::Hero_Torrasque ) return true;
      break;
      case Unclean_One:
        if( u->getType() == BWAPI::UnitTypes::Hero_Unclean_One ) return true;
      break;
      case Yggdrasill:
        if( u->getType() == BWAPI::UnitTypes::Hero_Yggdrasill ) return true;
      break;
      case Creep_Colony:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Creep_Colony ) return true;
      break;
      case Defiler_Mound:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Defiler_Mound ) return true;
      break;
      case Evolution_Chamber:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Evolution_Chamber ) return true;
      break;
      case Extractor:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Extractor ) return true;
      break;
      case Greater_Spire:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Greater_Spire ) return true;
      break;
      case Hatchery:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Hatchery ) return true;
      break;
      case Hive:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Hive ) return true;
      break;
      case Hydralisk_Den:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Hydralisk_Den ) return true;
      break;
      case Infested_Command_Center:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Infested_Command_Center ) return true;
      break;
      case Lair:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Lair ) return true;
      break;
      case Nydus_Canal:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Nydus_Canal ) return true;
      break;
      case Queens_Nest:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Queens_Nest ) return true;
      break;
      case Spawning_Pool:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Spawning_Pool ) return true;
      break;
      case Spire:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Spire ) return true;
      break;
      case Spore_Colony:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Spore_Colony ) return true;
      break;
      case Sunken_Colony:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Sunken_Colony ) return true;
      break;
      case Ultralisk_Cavern:
        if( u->getType() == BWAPI::UnitTypes::Zerg_Ultralisk_Cavern ) return true;
      break;
      case Cerebrate:
        if( u->getType() == BWAPI::UnitTypes::Special_Cerebrate ) return true;
      break;
      case Cerebrate_Daggoth:
        if( u->getType() == BWAPI::UnitTypes::Special_Cerebrate_Daggoth ) return true;
      break;
      case Mature_Chrysalis:
        if( u->getType() == BWAPI::UnitTypes::Special_Mature_Chrysalis ) return true;
      break;
      case Overmind:
        if( u->getType() == BWAPI::UnitTypes::Special_Overmind ) return true;
      break;
      case Overmind_Cocoon:
        if( u->getType() == BWAPI::UnitTypes::Special_Overmind_Cocoon ) return true;
      break;
      case Overmind_With_Shell:
        if( u->getType() == BWAPI::UnitTypes::Special_Overmind_With_Shell ) return true;
      break;
      case Bengalaas:
        if( u->getType() == BWAPI::UnitTypes::Critter_Bengalaas ) return true;
      break;
      case Kakaru:
        if( u->getType() == BWAPI::UnitTypes::Critter_Kakaru ) return true;
      break;
      case Ragnasaur:
        if( u->getType() == BWAPI::UnitTypes::Critter_Ragnasaur ) return true;
      break;
      case Rhynadon:
        if( u->getType() == BWAPI::UnitTypes::Critter_Rhynadon ) return true;
      break;
      case Scantid:
        if( u->getType() == BWAPI::UnitTypes::Critter_Scantid ) return true;
      break;
      case Ursadon:
        if( u->getType() == BWAPI::UnitTypes::Critter_Ursadon ) return true;
      break;
      case Mineral_Field:
        if( u->getType() == BWAPI::UnitTypes::Resource_Mineral_Field ) return true;
      break;
      case Vespene_Geyser:
        if( u->getType() == BWAPI::UnitTypes::Resource_Vespene_Geyser ) return true;
      break;
      case Dark_Swarm:
        if( u->getType() == BWAPI::UnitTypes::Spell_Dark_Swarm ) return true;
      break;
      case Disruption_Web:
        if( u->getType() == BWAPI::UnitTypes::Spell_Disruption_Web ) return true;
      break;
      case Scanner_Sweep:
        if( u->getType() == BWAPI::UnitTypes::Spell_Scanner_Sweep ) return true;
      break;
      case Protoss_Beacon:
        if( u->getType() == BWAPI::UnitTypes::Special_Protoss_Beacon ) return true;
      break;
      case Protoss_Flag_Beacon:
        if( u->getType() == BWAPI::UnitTypes::Special_Protoss_Flag_Beacon ) return true;
      break;
      case Terran_Beacon:
        if( u->getType() == BWAPI::UnitTypes::Special_Terran_Beacon ) return true;
      break;
      case Terran_Flag_Beacon:
        if( u->getType() == BWAPI::UnitTypes::Special_Terran_Flag_Beacon ) return true;
      break;
      case Zerg_Beacon:
        if( u->getType() == BWAPI::UnitTypes::Special_Zerg_Beacon ) return true;
      break;
      case Zerg_Flag_Beacon:
        if( u->getType() == BWAPI::UnitTypes::Special_Zerg_Flag_Beacon ) return true;
      break;
      case Powerup_Data_Disk:
        if( u->getType() == BWAPI::UnitTypes::Powerup_Data_Disk ) return true;
      break;
      case Powerup_Flag:
        if( u->getType() == BWAPI::UnitTypes::Powerup_Flag ) return true;
      break;
      case Powerup_Khalis_Crystal:
        if( u->getType() == BWAPI::UnitTypes::Powerup_Khalis_Crystal ) return true;
      break;
      case Powerup_Khaydarin_Crystal:
        if( u->getType() == BWAPI::UnitTypes::Powerup_Khaydarin_Crystal ) return true;
      break;
      case Powerup_Psi_Emitter:
        if( u->getType() == BWAPI::UnitTypes::Powerup_Psi_Emitter ) return true;
      break;
      case Powerup_Uraj_Crystal:
        if( u->getType() == BWAPI::UnitTypes::Powerup_Uraj_Crystal ) return true;
      break;
      case Powerup_Young_Chrysalis:
        if( u->getType() == BWAPI::UnitTypes::Powerup_Young_Chrysalis ) return true;
      break;
      case None:
        if( u->getType() == BWAPI::UnitTypes::None ) return true;
      break;
      case Unknown_Unit:
        if( u->getType() == BWAPI::UnitTypes::Unknown ) return true;
      break;
    }
    return false;
  }
  ...
  BWAPI::Position UnitGroup::getCenter() const
  {
    if ( this->empty() )
    ...
    return BWAPI::Position( (int)( x/count ), (int)( y/count ) );
  }
